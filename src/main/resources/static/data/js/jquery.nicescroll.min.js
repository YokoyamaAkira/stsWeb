...
--
*/
(function(e){var k=false,l=false,n=function(){var e=document.getElementsByTagName("script"),e=e[e.length-1].src.split("?")[0];return e.split("/").length>0?e.split("/").slice(0,-1).join("/")+"/":""}(),m=function(f){var b=this;this.opt={doc:e("body"),win:false,zindex:9E3,cursoropacitymin:0,cursoropacitymax:1,cursorcolor:"#014099",cursorwidth:"10px",cursorborder:"1px solid #fff",cursorborderradius:"5px",scrollspeed:20,mousescrollstep:48,touchbehavior:false,hwacceleration:true,usetransition:true,boxzoom:false,
